...
def instructions_selection(item_key):
    # Eğer instructions ekranında Return to Main Menu butonuna 2 sn beklendi ise:
...
def show_instructions_gui():
    ...
    # Return to main menu butonunu diğer butonlar gibi hover-to-select mekanizmasına dahil edelim
...
def show_game():
    ...
    # Meyveleri rastgele yerleştiriyoruz
    for i in range(5):
    ...
    # Sepeti tam (600,600)'e koyuyoruz
    basket_x = 600
    basket_y = 600
    ...
    # Canvas'ı güncelleyip basketi merkeze almak için
    canvas.update_idletasks()

    # fraction = offset/total_region_size = 300/1200 = 0.25
    # Bu sayede sol üst köşe (300,300) noktasına ayarlanır ve (600,600)'deki basket tam ortada görünür.
...
def start_app():
    show_menu()
    # İlk başlarken instructions GUI açalım
    show_instructions_gui()
